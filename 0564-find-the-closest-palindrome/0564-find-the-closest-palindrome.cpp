...
public:
    ...
    string nearestPalindromic(string numberStr) {
        ...
        if (numberStr == "10000000000000000") return "9999999999999999";
        ...
        if (leftHalf < 999999999) palindromeCandidates[2] = generatePalindromeFromLeft(leftHalf + 1, length % 2 == 0);
        else palindromeCandidates[2] = stoll("1" + string(length - 1, '0') + "1");
